...
public class attaccanteJava extends giocatoreJava {
private int velocita, tiro, passaggio, dribbling, difesa, fisico;
	
	public attaccanteJava(){
		super();
		velocita=50;tiro=50;passaggio=50;dribbling=50;fisico=50;
	}
	public attaccanteJava(String n, String c, int e, String cam, String cl, String naz){
    ...
    public double calcolaOverallGiocatore(){
    	return Math.floor((difesa*0.02) + (fisico*0.05) + (velocita*0.30) + (tiro*0.30) + (passaggio*0.08) + (dribbling*0.25));
    }
}
